...
# Menu for Soccer
sport1 = SportCategory(name="Soccer")
...
session.commit()
# Menu for Hockey
sport2 = SportCategory(name="Hockey")
...
competition.",price="$19.99", sport=sport2)
session.add(item3)
session.add(item4)
session.commit()
# Menu for BasketBall 
sport3 = SportCategory(name="BasketBall")
...
session.commit()
# Menu for Boxing
sport4 = SportCategory(name="Boxing")
...
session.commit()
# Menu for Rugby
sport5 = SportCategory(name="Rugby")
...
sport6 = SportCategory(name="SnowBoarding")
